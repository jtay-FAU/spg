    ...
    if check_password():
        ...
        if st.button("Generate Posts"):
            ...
            for platform, (post, logo_file) in posts.items():
                ...
                st.markdown(f'<div style="margin-left:10px;"><div style="width:100%; padding:10px; border-radius:5px; word-wrap: break-word;"><pre>{post}</pre></div></div>', unsafe_allow_html=True)
